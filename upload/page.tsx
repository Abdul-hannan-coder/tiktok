  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        {/* Header */}
        <div className="relative overflow-hidden bg-linear-to-br from-[#0A012A] via-[#1A103D] to-[#0A012A] rounded-2xl p-4 sm:p-6 lg:p-8">
          <div className="absolute inset-0 bg-linear-to-r from-[#6C63FF]/10 via-[#FF2E97]/10 to-[#6C63FF]/10"></div>
          <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
          <div className="relative z-10">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2">Upload Video</h1>
            <p className="text-sm sm:text-base text-[#C5C5D2]">Choose the type of content you want to create and share</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-2 bg-[#1A103D]/50 backdrop-blur-sm border-0 shadow-xl shadow-[#6C63FF]/30">
            <CardHeader className="text-center pb-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-[#00F5FF] to-[#6C63FF] rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:from-[#00E5E5] group-hover:to-[#5A52E6] transition-colors">
                <Video className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
              </div>
              <CardTitle className="text-lg sm:text-xl lg:text-2xl text-white mb-2">Upload Video File</CardTitle>
              <p className="text-xs sm:text-sm text-[#C5C5D2]">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-2 bg-[#1A103D]/50 backdrop-blur-sm border-0 shadow-xl shadow-[#6C63FF]/30">
            <CardHeader className="text-center pb-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-[#FF6B6B] to-[#4ECDC4] rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:from-[#FF5555] group-hover:to-[#3EC7C4] transition-colors">
                <Video className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
              </div>
              <CardTitle className="text-lg sm:text-xl lg:text-2xl text-white mb-2">Video Draft Posting</CardTitle>
              <p className="text-xs sm:text-sm text-[#C5C5D2]">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-2 bg-[#1A103D]/50 backdrop-blur-sm border-0 shadow-xl shadow-[#6C63FF]/30">
            <CardHeader className="text-center pb-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-[#6C63FF] to-[#FF2E97] rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:from-[#5A52E6] group-hover:to-[#E61E87] transition-colors">
                <Image className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
              </div>
              <CardTitle className="text-lg sm:text-xl lg:text-2xl text-white mb-2">TikTok Photo Draft Post</CardTitle>
              <p className="text-xs sm:text-sm text-[#C5C5D2]">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-2 bg-[#1A103D]/50 backdrop-blur-sm border-0 shadow-xl shadow-[#FF2E97]/30">
            <CardHeader className="text-center pb-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-r from-[#FF2E97] to-[#6C63FF] rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:from-[#E61E87] group-hover:to-[#5A52E6] transition-colors">
                <Image className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
              </div>
              <CardTitle className="text-lg sm:text-xl lg:text-2xl text-white mb-2">TikTok Photo Direct Post</CardTitle>
              <p className="text-xs sm:text-sm text-[#C5C5D2]">
